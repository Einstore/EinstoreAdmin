			...
			<div className="card-info-detail-message">
				...
				<div className="card-info-detail-message-item">
					<div className="card-info-detail-message-header">
						<div className="card-info-detail-message-header-name">{this.props.name}</div>
						<div className="card-info-detail-message-header-date">{this.props.date}</div>
					</div>
					<div className="card-info-detail-message-content">{this.props.content}</div>
				</div>
			</div>
		)
	}
